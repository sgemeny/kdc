...
//----------------------------------------
{
  ...
  if ($sts)
  {
    ...
    echo '<div id="chooseItem">';
      echo '<input type="text" placeholder="Search.." id="myInput" 
                   onkeyup="myFilter(event)">';
//      echo '<input id="btnSelectItem" class="myButton" 
//                   name="btnSelectItem" type="button" value="' . $btnCap . '">';
