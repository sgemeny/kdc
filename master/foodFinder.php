...
if ($embedded == 0)
{
  ...
  echo '<div class="footer">';
    echo '<p>KidneyDietCentral &copy 2019</p>';
    echo '<a id="terms" href="terms-conditions");">Terms and Conditions</a>';
    echo ' | ';
    echo '<a id="privacy" href="privacy-policy");">Privacy Policy</a>';
    echo '<p>Food data taken from the USDA Standard Reference Database</p>';
  echo '</div>';
